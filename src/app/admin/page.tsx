...
const translations = {
  ...
  ru: {
    ...
    merchants: "Активные рестораны/клубы",
  ...
  id: {
    ...
    merchants: "Restoran & Klub Pantai Aktif",
  ...
  es: {
    ...
    merchants: "Restaurantes Activos",
