  ...
  return (
    <>
      ...
      <div style={{
        ...
        left: 0, width: '280px', maxWidth: '85vw', 
        background: 'var(--background)', borderRight: '1px solid var(--surface-border)',
          ...
          {loading ? (
            ...
            <>
              ...
              <div style={{ ...rowStyle, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '4px' }}>
                ...
                <select value={lang} onChange={(e) => handleLangChange(e.target.value)} style={{ background: 'transparent', border: 'none', padding: 0, margin: 0, fontSize: '0.85rem', color: 'var(--primary)', fontWeight: 600, cursor: 'pointer', outline: 'none' }}>
              ...
              <div style={{ ...rowStyle, display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: '4px' }}>
                ...
                <select value={currency} onChange={(e) => handleCurrencyChange(e.target.value)} style={{ background: 'transparent', border: 'none', padding: 0, margin: 0, fontSize: '0.85rem', color: 'var(--primary)', fontWeight: 600, cursor: 'pointer', outline: 'none' }}>
              ...
              <div style={{ ...rowStyle, display: 'flex', flexDirection: 'column', gap: '6px' }}>
                ...
                {isBinding && !cardBound && (
                  <form onSubmit={handleBindCard} style={{ width: '100%', display: 'flex', gap: '8px', marginTop: '6px' }}>
                    ...
                    <button type="submit" className="btn-primary" style={{ padding: '6px 12px', fontSize: '0.85rem', borderRadius: '6px' }}>OK</button>
                  </form>
                )}
              </div>
            </>
        ...
        <div style={{ padding: '1.2rem 1.5rem', borderTop: '1px solid var(--surface-border)', display: 'flex', gap: '1rem', background: 'var(--background)' }}>
          <button onClick={handleLogout} style={{ flex: 1, padding: '10px', borderRadius: '10px', background: 'rgba(244, 63, 94, 0.1)', border: '1px solid rgba(244, 63, 94, 0.2)', color: 'var(--error)', fontSize: '0.9rem', fontWeight: 600, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', cursor: 'pointer' }}>
            🚪 Logout
          </button>
        </div>
      </div>
